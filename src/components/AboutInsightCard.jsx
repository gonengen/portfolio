export default function AboutInsightCard({ icon, iconAlt, lead, emphasis, className = '' }) {
  return (
    <article
      className={`flex w-full flex-col items-start gap-[var(--spacing-element-y)] rounded-[var(--radius-xl)] bg-container px-[var(--spacing-element-x)] py-[var(--spacing-element-y)] sm:flex-row sm:items-center ${className}`.trim()}
    >
